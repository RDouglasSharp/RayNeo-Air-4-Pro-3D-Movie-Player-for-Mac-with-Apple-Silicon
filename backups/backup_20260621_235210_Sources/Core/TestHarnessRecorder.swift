...
public struct TimingReport: Codable {
    ...
    public init(
        ...
        self.outputFPS = processedFrames / Int(max(wallClockSeconds, 0.001))
    ...
    public func startRecording(width: Int, height: Int, fps: Double) throws {
        ...
        videoSettings = [
            ...
            AVVideoCompressionPropertiesKey: [
                ...
                AVVideoMaxKeyFrameIntervalKey: Int(fps), // every frame is key (compression-friendly for post-processing)
